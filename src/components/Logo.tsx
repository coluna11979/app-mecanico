  ...
  return (
    <div className="inline-flex items-center gap-2.5">
      <svg width={size} height={size} viewBox="0 0 64 64" aria-label="MecânicoApp">
        ...
        <rect width="64" height="64" rx="14" fill={light ? '#1e2530' : '#0B1117'} />
        <path
          fill="url(#lg-grad)"
        ...
        />
        <circle cx="32" cy="23" r="3" fill={light ? '#1e2530' : '#0B1117'} />
      </svg>
      {withText && (
        <span className={`font-display font-bold text-lg tracking-tight ${light ? 'text-white' : ''}`}>
